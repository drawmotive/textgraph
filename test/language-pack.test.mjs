...
test('Simplified Chinese pack supplies a usable font URL without importing a runtime', async () => {
  ...
  const metadata = JSON.parse(await readFile(new URL('../language-packs/zh-cn/package.json', import.meta.url)));
  assert.equal(metadata.name, '@drawmotive/textgraph-fonts-zh-cn');
